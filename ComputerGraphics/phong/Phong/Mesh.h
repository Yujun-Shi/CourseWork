...
public:
    ...
    Mesh(vector<Vertex> vertices, vector<unsigned int> indices, vector<Texture> textures,
        glm::vec3 diffuse_, glm::vec3 specular_, glm::vec3 ambient_, glm::vec3 emissive_,
        glm::vec3 transparent_, float refract_) {
    ...
    void Draw(Shader shader) {
        ...
        shader.setVec3("m_emissive", emissive);
        shader.setVec3("m_transparent", transparent);
        shader.setFloat("m_ref", refract);
