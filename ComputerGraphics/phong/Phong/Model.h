...
private:
    ...
    Mesh processMesh(aiMesh *mesh, const aiScene *scene) {
        ...
        for (unsigned int i = 0; i < mesh->mNumVertices; i++) {
            ...
            // color
            if (mesh->mColors[0]) { // if we have color here
                ...
                // if no color, fill it with default color
                vector.r = 0.3;
                vector.g = 0.5;
                vector.b = 0.7;
                vertex.Color = vector;
        ...
        glm::vec3 transparent(0.0);
        material->Get(AI_MATKEY_COLOR_TRANSPARENT, temp);
        transparent.b = temp.b;
        transparent.g = temp.g;
        transparent.r = temp.r;

        float refract = 0;
        material->Get(AI_MATKEY_REFRACTI, refract);

        /*
        cout << "ref" << refract << endl;
        cout << transparent.x << endl;
        cout << transparent.y << endl;
        cout << transparent.x << endl;
        cout << "one" << endl;
        */
...
unsigned int TextureFromFile(const char *path, const string &directory, bool gamma) {
    ...
    // don't use this linux style stuff
